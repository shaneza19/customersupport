...
class App extends Component {
  componentDidMount = async () => {
    ...
    const result = await Axios.get(
      "https://helpdesk-support-ticket-default-rtdb.asia-southeast1.firebasedatabase.app/Employee.json"
    );
    ...
    const result2 = await Axios.get(
      "https://helpdesk-support-ticket-default-rtdb.asia-southeast1.firebasedatabase.app/Software.json"
    );

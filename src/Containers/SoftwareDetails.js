...
class SoftwareDetails extends Component {
    ...
    submit=async()=>{
        let result=await Axios.put("https://helpdesk-support-ticket-default-rtdb.asia-southeast1.firebasedatabase.app/Software/"+this.state.Software.key+".json",this.state.Softwareedit)
        if(result.status===200){
            let result2=await Axios.get("https://helpdesk-support-ticket-default-rtdb.asia-southeast1.firebasedatabase.app/Software.json")

    ...
    propcopy.map(obj => {
        ...
        if(object1keys.length===4){
            if (
                ...
                obj.Status === this.object1.Status &&
      ...
      if (object1keys.length === 3) {
        if (
          obj.Company === this.object1.Company &&
          obj.Software === this.object1.Software &&
          obj.Status === this.object1.Status && obj.AssignedTo !== "" && obj.Resolved!==true
        ) {
        //   console.log("here1");
          List.push(obj);
        }
        if (
            ...
            obj.Software === this.object1.Software &&
            obj.Status === this.object1.Status && obj.Employee !== undefined && obj.AssignedTo !== "" && obj.Resolved!==true
          ) {
            // console.log("here1");
            List.push(obj);
          }
      ...
      if (object1keys.length === 1) {
        ...
        if (obj.Status === this.object1.Status && obj.AssignedTo !== "" && obj.Resolved!==true) {
        //   console.log("here13");
          List.push(obj);
        }
    ...
    />
     ...
     <ExcelExport
                ...
                >
                    ...
                    <ExcelExportColumn field="status" title="status" locked={true} width={200} />
